 ...
 * @memberof createOrDelete
 *
 * Creates any type of File specified using mimeType.
 *
 * @param {string} [fileBody]            - The the contents of the file to create
 ...
 */
NodeGoogleDrive.prototype.createFile = function (
  fileBody,
  parentFolder,
  destinationFilename,
  mimeType
